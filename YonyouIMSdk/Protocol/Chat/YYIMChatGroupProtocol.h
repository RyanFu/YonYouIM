 ...
 *  @param content 群公告
 */
- (void)setGroupAnnouncementWithGroup:(NSString *)groupId content:(NSString *)content complete:(void (^)(BOOL result, YYChatGroup * groupInfo, YYIMError *error)) complete;
/**
 *  添加管理员
 *
 *  @param groupId 群ID
 *  @param adminId 管理员数组(id)
 */
