...
- (void)viewDidLoad {
    ...
    UIButton *orgButton = [[UIButton alloc] initWithFrame:CGRectMake(20.0f, 4.0f, buttonWith, 60.0f)];
    [orgButton setBackgroundColor:[UIColor clearColor]];
    [orgButton setImage:[UIImage imageNamed:@"icon_org"] forState:UIControlStateNormal];
    [orgButton setTitle:@"组织架构" forState:UIControlStateNormal];
    [orgButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    orgButton.titleLabel.font = [UIFont systemFontOfSize:12];
    orgButton.titleLabel.textAlignment = NSTextAlignmentCenter;
    [orgButton setImageEdgeInsets:UIEdgeInsetsMake(0, 10.0f, 20.0f, 10.0f)];
    [orgButton setTitleEdgeInsets:UIEdgeInsetsMake(42.0f, -40.f, 0, 0)];
    [orgButton addTarget:self action:@selector(useOrgView) forControlEvents:UIControlEventTouchUpInside];
    ...
    [choiceView addSubview:orgButton];
...
- (void)useOrgView{
    ...
    orgViewController.inviteDelegate = self;
    orgViewController.actionName = self.actionName;
