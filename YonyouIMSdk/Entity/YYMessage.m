...
- (BOOL)isAtMe {
    return [[[self getMessageContent] atUserArray] containsObject:[[YYIMConfig sharedInstance] getUser]] || [[[self getMessageContent] atUserArray] containsObject:[YYIMStringUtility getAllUserId]];
}
