...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[YYIMChat sharedInstance] registerApnsCerName:@"yyimpro_dev"];
#else
    [[YYIMChat sharedInstance] registerApnsCerName:@"yyimpro_dis"];
#endif
    ...
    // 设置高德地图key，参见高德地图官网
    [[MAMapServices sharedServices] setApiKey:@"db6bb485ce10f04ccde11aaafc6956fd"];
    [[AMapSearchServices sharedServices] setApiKey:@"db6bb485ce10f04ccde11aaafc6956fd"];
    // 设置蒲公英appId，参见蒲公英官网
    [[PgyUpdateManager sharedPgyManager] startManagerWithAppId:@"b331cd19b047f636b0eed93a1b745349"];
    // Bugly
    BuglyConfig *config = [[BuglyConfig alloc] init];
    [config setBlockMonitorEnable:YES];
    [Bugly startWithAppId:@"900020126" config:config];
    // 微信
    [WXApi registerApp:@"wx845b334ce05416fb"];
