...
#pragma mark version 17

#define YYIM_DB_VERSION_17      17

#define YYIM_CHATGROUP_ADD_CREATOR @"ALTER TABLE yyim_chatgroup ADD chat_announ_creator TEXT"
#define YYIM_CHATGROUP_ADD_CONTENT @"ALTER TABLE yyim_chatgroup ADD hat_announ_content TEXT"
#define YYIM_CHATGROUP_ADD_ANNOUN_TS @"ALTER TABLE yyim_chatgroup ADD hat_announ_ts INTEGER"
#define YYIM_CHATGROUPMEMBER_ADD_TS @"ALTER TABLE yyim_chatgroup_member ADD assign_admints INTEGER"

#pragma mark db update sql
#define YYIM_DBINFO_UPDATE @"UPDATE yyim_dbinfo SET version=?"

// 群组表插入
#define YYIM_CHATGROUP_INSERT_NEW @"INSERT INTO yyim_chatgroup(user_id,chatgroup_id,chatgroup_name,chatgroup_tag,chatgroup_tag2,chatgroup_tag3,chatgroup_tag4,chatgroup_tag5,chatgroup_collect,is_super,member_count,is_owner,ts,chat_announ_creator,hat_announ_content,hat_announ_ts) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
// 群组表更新
#define YYIM_CHATGROUP_UPDATE_NEW @"UPDATE yyim_chatgroup SET chatgroup_name=?,chatgroup_tag=?,chatgroup_tag2=?,chatgroup_tag3=?,chatgroup_tag4=?,chatgroup_tag5=?,chatgroup_collect=?,is_super=?,member_count=?,is_owner=?,ts=?,chat_announ_creator=?,hat_announ_content=?,hat_announ_ts=? WHERE user_id=? AND chatgroup_id=?"
// 群组成员表更新
#define YYIM_CHATGROUPMEMBER_UPDATE_NEW @"UPDATE yyim_chatgroup_member SET member_name=?,member_photo=?,affiliation=?,assign_admints=? WHERE user_id=? AND chatgroup_id=? AND member_id=?"
// 群组成员表插入
#define YYIM_CHATGROUPMEMBER_INSERT_NEW @"INSERT INTO yyim_chatgroup_member(user_id,chatgroup_id,member_id,member_name,member_photo,affiliation,assign_admints) VALUES (?,?,?,?,?,?,?)"
#endif
