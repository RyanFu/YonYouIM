...
- (NSString *)prepareAccount:(NSString *)account password:(NSString *)password error:(NSError **)errPtr {
    ...
    if (matchSingle) {
        ...
        [userDefaults setObject:[[YYIMTargetManager sharedManager] getDefaultAppKey] forKey:YYIM_APPKEY];
        [userDefaults setObject:[[YYIMTargetManager sharedManager] getDefaultEtpKey] forKey:YYIM_ETPKEY];
        [userDefaults setObject:account forKey:YYIM_ACCOUNT];
        [userDefaults setObject:password forKey:YYIM_PASSWORD];
        [userDefaults synchronize];
        return account;
