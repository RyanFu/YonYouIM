#import "YMDDDispatchQueueLogFormatter.h"
...
@implementation YMDDDispatchQueueLogFormatter
{
...
- (NSString *)queueThreadLabelForLogMessage:(YMDDLogMessage *)logMessage
{
    // As per the YMDDLogFormatter contract, this method is always invoked on the same thread/dispatch_queue
...
- (NSString *)formatLogMessage:(YMDDLogMessage *)logMessage
{
...
- (void)didAddToLogger:(id <YMDDLogger>)logger
{
    OSAtomicIncrement32(&atomicLoggerCount);
}

- (void)willRemoveFromLogger:(id <YMDDLogger>)logger
{
