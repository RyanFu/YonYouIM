...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[YYIMChat sharedInstance] registerApnsCerName:@"yyimexp_dev"];
#else
    [[YYIMChat sharedInstance] registerApnsCerName:@"yyimexp_dis"];
#endif
    ...
    // 设置高德地图key，参见高德地图官网
    [[MAMapServices sharedServices] setApiKey:@"6713885c81e95e44229e4f128b25258a"];
    [[AMapSearchServices sharedServices] setApiKey:@"6713885c81e95e44229e4f128b25258a"];
    // 设置蒲公英appId，参见蒲公英官网
    [[PgyUpdateManager sharedPgyManager] startManagerWithAppId:@"bd611b1bb7ad52336c84eb60f587ceb1"];
    // Bugly
    BuglyConfig *config = [[BuglyConfig alloc] init];
    [config setBlockMonitorEnable:YES];
    [Bugly startWithAppId:@"900027375" config:config];
    // 微信
