...
#define YM_SETTINGS_TRMP_NO_DISTURB         @"YM_SETTINGS_TRMP_NO_DISTURB"
...
#define DEFAULT_REVOKE_EXTEND               @"DEFAULT_REVOKE_EXTEND"
...
/**  新添加*/
#pragma mark Recent contact
#define DEFAULT_USER_RECENT_CONTACT                     @"{scheme}://{restServer}/sysadmin/rest/user/{etpId}/{appId}/{username}/contactsmessage/digest"
#define DEFAULT_GROUP_ANNOUNCEMENT                      @"{scheme}://{restServer}/sysadmin/rest/user/{etpId}/{appId}/{username}/rooms/{mucId}/announcement"
#define DEFAULT_ADD_GROUP_ADMIN                     @"{scheme}://{restServer}/sysadmin/rest/user/{etpId}/{appId}/{userId}/rooms/{mucId}/administrator/assignment"
#define DEFAULT_DELETE_GROUP_ADMIN                      @"{scheme}://{restServer}/sysadmin/rest/user/{etpId}/{appId}/{userId}/rooms/{mucId}/administrator/cancel"
#define DEFAULT_PUBACCOUNT_MESSAGE                      @"{scheme}://{restServer}/sysadmin/rest/remote/{etpId}/{appId}/{pubId}/pubaccountmenu/msgModel/{msgModel}"
#define DEFAULT_READ_MESSAGE_NUMBER                      @"{scheme}://{restServer}/sysadmin/rest/user/{etpId}/{appId}/{userId}/rooms/msgStatRead/{mucId}"
#define DEFAULT_USER_READ_MESSAGE_NUMBER                 @"{scheme}://{restServer}/sysadmin/rest/user/{etpId}/{appId}/{userId}/rooms/msgStatRead/{mucId}/readMem/{packetId}"
#define DEFAULT_USER_READ_SILENCE_MODEL                @"{scheme}://{restServer}/sysadmin/rest/user/{etpId}/{appId}/{userId}/profile/silencemode"
#define DEFAULT_USER_PROFILE_NODISTURBANCE_SERVLET      @"{scheme}://{restServer}/sysadmin/rest/user/{etpId}/{appId}/{userId}/profile/nodisturbance"
#define DEFAULT_USER_PROFILE_NODISTURBANCE_MUTE      @"{scheme}://{restServer}/sysadmin/rest/user/{etpId}/{appId}/{userId}/profile/mute"  // 静音

#define DEFAULT_USER_TOKEN                              @"{scheme}://{restServer}/sysadmin/rest/{etpId}/{appId}/token"

#define DEFAULT_USER_FEEDBACK                             @"{scheme}://{restServer}/sysadmin/rest/user/{etpId}/{appId}/{userId}/feedback"
 ...
 *  @return 用户最近联系人
 */
- (NSString *)getUserRecentContact {
    NSString *user = [self getUser];
    if ([YYIMStringUtility isEmpty:user]) {
        YYIMLogError(@"unexpected empty user when getUserTagAddServlet");
        return nil;
    }
    NSString *servlet = DEFAULT_USER_RECENT_CONTACT;
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{scheme}" withString:[self getIMRestServerScheme]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{restServer}" withString:[self getIMRestServer]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{etpId}" withString:[self getEtpKey]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{appId}" withString:[self getAppKey]];
...
- (NSString *)getGroupAnnouncement:(NSString *)groupId {
    NSString *user = [self getUser];
    if ([YYIMStringUtility isEmpty:user]) {
        YYIMLogError(@"unexpected empty user when getUserTagAddServlet");
        return nil;
    }
    NSString *servlet = DEFAULT_GROUP_ANNOUNCEMENT;
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{scheme}" withString:[self getIMRestServerScheme]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{restServer}" withString:[self getIMRestServer]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{etpId}" withString:[self getEtpKey]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{appId}" withString:[self getAppKey]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{username}" withString:user];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{mucId}" withString:groupId];

    return servlet;
}

- (NSString *)getAddGroupAdministrators:(NSString *)groupId {
    NSString *user = [self getUser];
    if ([YYIMStringUtility isEmpty:user]) {
        YYIMLogError(@"unexpected empty user when getUserTagAddServlet");
        return nil;
    }
    NSString *servlet = DEFAULT_ADD_GROUP_ADMIN;
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{scheme}" withString:[self getIMRestServerScheme]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{restServer}" withString:[self getIMRestServer]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{etpId}" withString:[self getEtpKey]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{appId}" withString:[self getAppKey]];
...
- (NSString *)getDeleteGroupAdministrators:(NSString *)groupId {
    NSString *user = [self getUser];
    if ([YYIMStringUtility isEmpty:user]) {
        YYIMLogError(@"unexpected empty user when getUserTagAddServlet");
        return nil;
    }
    NSString *servlet = DEFAULT_DELETE_GROUP_ADMIN;
    //    @"{scheme}://{restServer}/sysadmin/rest/user/{etpId}/{appId}/{username}/rooms/{mucId}/announcement"
    ;
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{scheme}" withString:[self getIMRestServerScheme]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{restServer}" withString:[self getIMRestServer]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{etpId}" withString:[self getEtpKey]];
...
- (NSString *)getPubAccountMessageAccount:(NSString *)accountId msgModel:(NSInteger)msgModel {
    NSString *servlet = DEFAULT_PUBACCOUNT_MESSAGE;
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{scheme}" withString:[self getIMRestServerScheme]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{restServer}" withString:[self getIMRestServer]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{etpId}" withString:[self getEtpKey]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{appId}" withString:[self getAppKey]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{pubId}" withString:accountId];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{msgModel}" withString:[NSString stringWithFormat:@"%ld",(long)msgModel]];

    return servlet;
}
- (NSString *)getReadMessageNumberWithGroupId:(NSString *)groupId {
    NSString *user = [self getUser];
    if ([YYIMStringUtility isEmpty:user]) {
        YYIMLogError(@"unexpected empty user when getUserTagAddServlet");
        return nil;
    }
    NSString *servlet = DEFAULT_READ_MESSAGE_NUMBER;
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{scheme}" withString:[self getIMRestServerScheme]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{restServer}" withString:[self getIMRestServer]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{etpId}" withString:[self getEtpKey]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{appId}" withString:[self getAppKey]];
...
- (NSString *)getUserReadMessageNumberWithGroupId:(NSString *)groupId packetId:(NSString *)packetId {
    NSString *user = [self getUser];
    if ([YYIMStringUtility isEmpty:user]) {
        YYIMLogError(@"unexpected empty user when getUserTagAddServlet");
        return nil;
    }
    NSString *servlet = DEFAULT_USER_READ_MESSAGE_NUMBER;
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{scheme}" withString:[self getIMRestServerScheme]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{restServer}" withString:[self getIMRestServer]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{etpId}" withString:[self getEtpKey]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{appId}" withString:[self getAppKey]];
...
- (NSString *)updateImmersionMode {
    NSString *user = [self getUser];
    if ([YYIMStringUtility isEmpty:user]) {
        YYIMLogError(@"unexpected empty user when updateImmersionMode");
        return nil;
    }
    NSString *servlet = DEFAULT_USER_READ_SILENCE_MODEL;
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{scheme}" withString:[self getIMRestServerScheme]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{restServer}" withString:[self getIMRestServer]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{etpId}" withString:[self getEtpKey]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{appId}" withString:[self getAppKey]];
 ...
 *  @return 用户设置勿扰模式接口
 */
- (NSString *)getUserProfileNoDisturbanceServlet {
    NSString *user = [self getUser];
    if ([YYIMStringUtility isEmpty:user]) {
        YYIMLogError(@"unexpected empty user when getUserProfileNoDisturbanceServlet");
        return nil;
    }
    NSString *servlet = DEFAULT_USER_PROFILE_NODISTURBANCE_SERVLET;
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{scheme}" withString:[self getIMRestServerScheme]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{restServer}" withString:[self getIMRestServer]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{etpId}" withString:[self getEtpKey]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{appId}" withString:[self getAppKey]];
...
- (NSString *)getUserToken {
    NSString *servlet = DEFAULT_USER_TOKEN;
...
- (NSString *) getCurrentInterface {
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    return [userDefaults stringForKey:YM_SETTINGS_TRMP_NO_DISTURB];
}

- (void) setCurrentInterface:(NSString *)formId {
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    if (formId) {
        [userDefaults setObject:formId forKey:YM_SETTINGS_TRMP_NO_DISTURB];
    } else {
        [userDefaults removeObjectForKey:YM_SETTINGS_TRMP_NO_DISTURB];
    }

    [userDefaults synchronize];
}
- (NSString *) setUserMute {
    NSString *user = [self getUser];
    if ([YYIMStringUtility isEmpty:user]) {
        YYIMLogError(@"unexpected empty user when getUserProfileNoDisturbanceServlet");
        return nil;
    }
    NSString *servlet = DEFAULT_USER_PROFILE_NODISTURBANCE_MUTE;
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{scheme}" withString:[self getIMRestServerScheme]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{restServer}" withString:[self getIMRestServer]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{etpId}" withString:[self getEtpKey]];
    servlet = [servlet stringByReplacingOccurrencesOfString:@"{appId}" withString:[self getAppKey]];
...
- (BOOL)isNotRevokeExtend {
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    return [userDefaults boolForKey:DEFAULT_REVOKE_EXTEND];
}

- (void)setNotRevokeExtend:(BOOL)revokeExtend {
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    [userDefaults setBool:revokeExtend forKey:DEFAULT_REVOKE_EXTEND];
    [userDefaults synchronize];
}

- (NSString *)getUserFeedback {
    NSString *servlet = DEFAULT_USER_FEEDBACK;
    NSString *user = [self getUser];
    if ([YYIMStringUtility isEmpty:user]) {
        YYIMLogError(@"unexpected empty user when getUserFeedback");
        return nil;
    }
